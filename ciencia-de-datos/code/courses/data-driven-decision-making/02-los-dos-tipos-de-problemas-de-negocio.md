...
- Se apoya en visualización de datos (lección [05](../intro-ciencia-datos/05-visualizacion-y-comunicacion.md)) y estadística descriptiva (lección [04](../intro-ciencia-datos/04-estadistica-descriptiva-fundamental.md)).
